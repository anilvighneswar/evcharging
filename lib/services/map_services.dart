...
class MapServices {
  final String key = 'AIzaSyDaUG88b5nV0n7Unyjsx0WNzdbVtUaaUpo';
  ...
  Future<dynamic> getPlaceDetails(LatLng coords, int radius) async {
    ...
    final String url =
        'https://maps.googleapis.com/maps/api/place/nearbysearch/json?&location=$lat,$lng&radius=$radius&keyword=EV%20charging%20station&key=$key';
